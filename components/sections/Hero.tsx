...
>
            ...
            <a href="/resume.pdf" download="SufyanuddinTaha-SDE-Resume-2026.pdf" className="flex items-center gap-2 px-6 py-3 border border-white/10 hover:border-accent/50 text-foreground rounded-full transition-all duration-200 hover:text-accent text-sm font-medium">
             <Download size={16} />
                 Download Resume
                     </a>
          </motion.div>
